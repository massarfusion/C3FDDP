...
if data_mode == 'SHHA':
    ...
    # from extracted.get_dataloader import getSHHADataset as loading_data
    # from extracted.SHHAcfg  import SHHAcfg as cfg_data
...
if net in ['MCNN', 'AlexNet', 'VGG', 'VGG_DECODER', 'Res50', 'Res101', 'CSRNet','Res101_SFCN']:
    ...
    from trainerLoRA import Trainer
elif net in ['Diffusion']:
    from trainer_for_Diffusion import Trainer
elif net in ['SANet']: 
