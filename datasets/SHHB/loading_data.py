...
def loading_data():
    ...
    train_loader = DataLoader(train_set, batch_size=cfg_data.TRAIN_BATCH_SIZE, num_workers=NUM_WORKER_THREADS, shuffle=True, drop_last=True)
    ...
    val_loader = DataLoader(val_set, batch_size=cfg_data.VAL_BATCH_SIZE, num_workers=NUM_WORKER_THREADS, shuffle=True, drop_last=False)
