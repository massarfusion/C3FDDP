...
__C_SHHA.DATA_PATH = './ProcessedData/shanghaitech_part_A'# the relative path from current work directory

# __C_SHHA.STD_SIZE = (256,256)
# __C_SHHA.TRAIN_SIZE = (256,256) # 2D tuple or 1D scalar
# __C_SHHA.DATA_PATH = './cursed_data'
